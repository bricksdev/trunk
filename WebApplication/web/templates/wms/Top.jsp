    ...
    <div id="vmi_top_header">
        ...
        <div class="vmi_top_header_c">
            ...
            <div id="con_two_1" style="display:none">
                <li><a href="/wms_web/views/wms/asn/AsnSearch.jsp">送货单查询</a></li>
                <li><a href="/wms_web/views/wms/receive/receiveGoods/ReceiveGoodsSearch.jsp">收货管理</a></li>
            ...
            <div id="con_two_8" style="display:none">
                <li><a href="/wms_web/views/wms/receive/QCResultsQuery.jsp">质检查询</a></li>

...
(function(){
    ...
    var E=YAHOO.lang,F=YAHOO.util,A=F.Dom,T=F.Event,M=F.CustomEvent,K=YAHOO.util.KeyListener,I=F.Config,H=YAHOO.widget.Overlay,O=YAHOO.widget.Panel,L=YAHOO.env.ua,P=(L.ie&&(L.ie<=6||document.compatMode=="BackCompat")),G,Q,C,D={
        ...
        "CLOSEACTION":{//2010-05-29增加 关闭弹出窗口事件
            key:"closeaction",
            validator:true,
            value:function(){}
        }
...
(function(){
    ...
    YAHOO.extend(A,YAHOO.widget.Panel,{
        ...
        _doClose:function(I){
            if(this.cfg.getProperty("closeaction")){
                //2010-05-29增加 关闭弹出窗口事件
                this.cfg.getProperty("closeaction")();
            }
            B.preventDefault(I);
            this.cancel();
        },

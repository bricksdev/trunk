...
orphanTr : function(){ 
    ...
    createGridMenu :function(){
        ...
        var groupColDialog = !this.allowGroup? null : Sigma.createColumnDialog('group' , {
            gridId : gridId ,
    ...
    var freezeColDialog = !this.allowFreeze? null : Sigma.createColumnDialog('freeze' , {
        gridId : gridId ,
        checkValid : function(r){
            return r.frozen;
        },
...
var hideColDialog = !this.allowHide ? null : Sigma.createColumnDialog('show' , {
    gridId : gridId ,
    checkValid : function(r){
        return !r.hidden;
    },
...
if (this.allowCustomSkin){
    ...
    for (var i=0;i<this.skinList.length;i++){
        skinItemList.push(new Sigma.MenuItem({
            gridId:this.id,
            type :'radiobox',
...
this.gridMenuButton.addMenuItems( [
    ...
    groupColDialog ? new Sigma.MenuItem({
        gridId:grid.id,
        type :'',
...
freezeColDialog ? new Sigma.MenuItem({
    gridId:grid.id,
    type :'',
...
hideColDialog ? new Sigma.MenuItem({
    gridId:grid.id,
    type :'',
    ...
    switch (type) {
        case 'filter':
            /*
				...
				*/
            grid.filterDialog= grid.filterDialog || Sigma.createFilterDialog( {
        ...
        case 'chart':
            ...
            var w=300,h=300;
            if (record) {
                grid.charDialog= grid.charDialog || new Sigma.Dialog({
                    gridId : grid.id ,

...
public class TypeInitialization {
     ...
     * @return
     */
    public static List<Object> initializeGenericList(Type type) throws AppException {
     ...
     * @return
     */
    public static Object initializeObject(Class<?> clazz) throws AppException {
     ...
     * 模拟返回的数据
     */
    private static Object invoke(Field method) throws AppException {
     ...
     * @return
     */
    public static List<Object> initializeList(Class<?> clazz) throws AppException {

 ...
 * @author xy
 */
public class WmsTableComponent extends ElementComponent {

    @Override
    public void parser(ContainHTMLElementTag parentElement) {
        
        DivElementTag tableContntDiv = new DivElementTag("tableContentDiv","vmi_table_gdt");
        // 设定表格的内部表格
        parentElement.addChildrenTag(tableContntDiv);
        ...
        for (Grid g : grids) {
            ...
            tableContntDiv.addChildrenTag(tableDiv);
...
//                                        selectElement.setValue(selectedValue);
                            ...
                            default:
                                ...
                                inputElement.setTabindex(String.valueOf(tabIndex.next()));
                                inputElement.setCssClass("tableInputElement");
                                inputElement.setTitle(e.label());
                                inputElement.setRequired(e.required());

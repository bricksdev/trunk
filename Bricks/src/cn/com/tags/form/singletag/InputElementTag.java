...
public class InputElementTag extends AbstractHtmlElementTag {
    ...
    protected void writeOptionalAttributes(TagWriter tagWriter)
        ...
        if (getMaxLength() > 0) {
            writeOptionalAttribute(tagWriter, _MAXLENGTH, String.valueOf(getMaxLength()));
        }
        writeOptionalAttribute(tagWriter, _REQUIRED, String.valueOf(isRequired()));
